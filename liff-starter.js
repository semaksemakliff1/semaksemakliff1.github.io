window.onload = function() {
    ...
    const defaultLiffId = "1661487665-RgGBpyna";
    let myLiffId = "1661487665-RgGBpyna";
    if (useNodeJS) {
        fetch('/liff/send-id', {
            headers: {
...
function sendLiff(){
    ...
    if (tipe === 'text') {
        liff.sendMessages([{
            ...
            sentBy: {
                label: "TEAM PLAY SEMAK SEMAK",
                iconUrl: "https://i.ibb.co/rM1X2Yw/imgbb.jpg",
                linkUrl: "https://SemakSemakv2.github.io"
            }
        }]).then(function () {
            liff.closeWindow();
        });
        ...
        if(prev !== null && prev !== '') {
            ...
            dura = "https://i.ibb.co/rM1X2Yw/imgbb.jpg";
        }
        liff.sendMessages([{
            type: 'video',
